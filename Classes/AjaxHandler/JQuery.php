...
class JQuery extends AbstractAjaxHandler {
			...
			<script type="text/javascript">
				function attachFileRemovalEvents' . $field . '() {
					' . $this->jQueryAlias . '("' . $this->formSelector . ' a.formhandler_removelink_' . $field . '").click(function() {
						...
						' . $this->jQueryAlias . '("' . $this->formSelector . ' #\Tx\Formhandler\UploadedFiles_' . $field . '").load(url + "#\Tx\Formhandler\UploadedFiles_' . $field . '", function() {
	...
	protected function addJS($js) {
		if($this->jsPosition === 'inline') {
			...
			$GLOBALS['TSFE']->additionalFooterData['\Tx\Formhandler\AjaxHandler_Jquery_' . $this->globals->getCObj()->data['uid']] .= $js;
		} else {
			$GLOBALS['TSFE']->additionalHeaderData['\Tx\Formhandler\AjaxHandler_Jquery_' . $this->globals->getCObj()->data['uid']] .= $js;
		}
	}
