<?php
namespace Tx\Formhandler\Debugger;
 ...
 *
 * $Id: \Tx\Formhandler\AbstractLogger.php 27708 2009-12-15 09:22:07Z reinhardfuehricht $
 *                                                                        */
 ...
 * @abstract
 */
abstract class AbstractDebugger extends \Tx\Formhandler\Component\AbstractComponent {
	...
	public function addToDebugLog($message = '', $severity = 1, array $data = array()) {
		...
		if (isset($trace[2])) {
			...
			if($section === '\Tx\Formhandler\Utils\UtilityFuncs') {
