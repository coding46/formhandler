<?php
namespace Tx\Formhandler\Utils;
...
class AjaxValidate {
	...
	public function main() {
		...
		if ($this->fieldname) {
			...
			$this->componentManager = \Tx\Formhandler\Component\Manager::getInstance();
			...
			$validator = $this->componentManager->getComponent('\Tx\Formhandler\Validator_Ajax');
			$errors = array();
	 ...
	 * @return \Tx\Formhandler\View\AjaxValidation The view class
	 */
	protected function initView($content) {
		$viewClass = '\Tx\Formhandler\View_AjaxValidation';
...
$validator = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('\Tx\Formhandler\Utils_AjaxValidate');
$validator->main();