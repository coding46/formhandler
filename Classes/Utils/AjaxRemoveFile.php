	...
	public function main() {
		...
		if ($this->fieldName) {
			...
			if (is_array($sessionFiles) && !empty($sessionFiles[$field])) {
				$markers = array();
				$view = $this->componentManager->getComponent('\Tx\Formhandler\View_Form');
...
$output = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('\Tx\Formhandler\Utils_AjaxRemoveFile');
$output->main();