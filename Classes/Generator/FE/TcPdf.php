<?php
namespace Tx\Formhandler\Generator\Fe;
...
class TcPdf extends AbstractGenerator {
	...
	public function process() {
		...
		$view = $this->componentManager->getComponent('\Tx\Formhandler\View_PDF');
		$this->filename = FALSE;
	...
	/* (non-PHPdoc)
	 * @see Classes/Generator/\Tx\Formhandler\AbstractGenerator#getComponentLinkParams($linkGP)
	*/
