<?php
namespace Tx\Formhandler\Generator;
 ...
 * @uses \Tx\Formhandler\Template_TCPDF
 */
class TcPdf {
	 ...
	 *
	 * @access protected
	 * @var \Tx\Formhandler\Template_TCPDF
	 */
	protected $pdf;
	 ...
	 * Default Constructor
	 *
	 * @param \Tx\Formhandler\Component\Manager $componentManager The component manager of Formhandler
	 * @return void
	 */
	...
	function generateModulePDF($records, $exportFields = array(), $fileName = 'formhandler.pdf') {
		...
		//init pdf object
		$this->pdf = $this->componentManager->getComponent('\Tx\Formhandler\Template_TCPDF');
