	...
	public function fillFileMarkers(&$markers) {
		...
		if (is_array($sessionFiles)) {
			foreach ($sessionFiles as $field => $files) {
				...
				$markers['###' . $field . '_uploadedFiles###'] = '<div id="\Tx\Formhandler\UploadedFiles_' . $field . '">' . $markers['###' . $field . '_uploadedFiles###'] . '</div>';
			}
