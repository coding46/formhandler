<?php
namespace Tx\Formhandler\Interceptor;
 ...
 *
 * This interceptor uses log entries made by \Tx\Formhandler\Logger_DB.
 *
 * Example:
 * <code>
 * saveInterceptors.1.class = \Tx\Formhandler\Interceptor_IPBlocking
 *
...
class IpBlocking extends AbstractInterceptor {
	 ...
	 * @var string
	 */
	protected $logTable = '\Tx\Formhandler\log';
