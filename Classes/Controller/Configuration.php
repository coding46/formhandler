...
class Configuration implements \ArrayAccess {
	...
	public function getPrefixedPackageKey() {
		return \Tx\Formhandler\Component\Manager::PACKAGE_PREFIX . '_' . self::PACKAGE_KEY;
	}
	...
	public function getPrefixedPackageKeyLowercase() {
		return strtolower(\Tx\Formhandler\Component\Manager::PACKAGE_PREFIX . '_' . self::PACKAGE_KEY);
	}
