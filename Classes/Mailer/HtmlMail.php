<?php
namespace Tx\Formhandler\Mailer;
 ...
 */
class HtmlMail extends AbstractMailer implements MailerInterface {
	...
	/* (non-PHPdoc)
	 * @see Classes/Component/\Tx\Formhandler\Component\AbstractClass#__construct()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#send()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setHTML()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setPlain()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setSubject()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setSender()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setReplyTo()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#addCc()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#addBcc()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#setReturnPath()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#addHeader()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#addAttachment()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getHTML()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getPlain()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getSubject()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getSender()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getReplyTo()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getCc()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getBcc()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Mailer/\Tx\Formhandler\MailerInterface#getReturnPath()
	*/
