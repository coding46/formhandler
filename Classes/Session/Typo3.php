<?php
namespace Tx\Formhandler\Session;
...
class Typo3 extends AbstractSession {
	...
	/* (non-PHPdoc)
	 * @see Classes/Session/\Tx\Formhandler\AbstractSession#set()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Session/\Tx\Formhandler\AbstractSession#setMultiple()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Session/\Tx\Formhandler\AbstractSession#get()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Session/\Tx\Formhandler\AbstractSession#exists()
	*/
	...
	/* (non-PHPdoc)
	 * @see Classes/Session/\Tx\Formhandler\AbstractSession#reset()
	*/
