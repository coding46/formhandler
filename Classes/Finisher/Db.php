 ...
 *
 * <code>
 * finishers.1.class = \Tx\Formhandler\Finisher_DB
 *
...
class Db extends AbstractFinisher {
	...
	public function init($gp, $settings) {
		...
		if (!$this->table) {
			$this->utilityFuncs->throwException('no_table', '\Tx\Formhandler\Finisher_DB');
			return;
		}
		
		if(!is_array($this->settings['fields.'])) {
			$this->utilityFuncs->throwException('no_fields', '\Tx\Formhandler\Finisher_DB');
			return;
		}
