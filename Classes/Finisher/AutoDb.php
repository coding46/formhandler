 ...
 *
 * $Id: \Tx\Formhandler\Finisher_AutoDB.php 38600 2010-09-25 19:52:03Z metti $
 *                                                                        */
...
class AutoDb extends Db {
	 ...
	 * @todo Make it protected var in \Tx\Formhandler\AbstractFinisher
	 * @var string
	 */
	public $settings;
	...
	/* (non-PHPdoc)
	 * @see Classes/Finisher/\Tx\Formhandler\Finisher_DB#parseFields()
	 */
