<?php
namespace Tx\Formhandler\Finisher;
 ...
 *
 * <code>
 * finishers.1.class = \Tx\Formhandler\Finisher_DifferentDB
 ...
 * </code>
 *
 * Further configuration equals the configuration of \Tx\Formhandler\Finisher_DB.
 *
 * @author	Reinhard Führicht <rf@typoheads.at>
 * @see \Tx\Formhandler\Finisher_DB
 */
class DifferentDb extends Db {
	 ...
	 *
	 * @see \Tx\Formhandler\Finisher_DB::save()
	 ...
	 *
	 * @see \Tx\Formhandler\Finisher_DB::init
	 * @return void
	 */
	public function init($gp, $settings) {
		...
		if (\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('adodb')) {
			...
			$this->utilityFuncs->throwException('extension_required', 'adodb', '\Tx\Formhandler\Finisher_DifferentDB');
		}
